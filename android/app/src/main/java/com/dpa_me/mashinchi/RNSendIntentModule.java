...
public class RNSendIntentModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void openAppWithData(String packageName, String dataUri, String ActionType , String mimeType, ReadableMap extras, final Promise promise) {
    ...
    public void openMaps(String query) {
      ...
      Intent sendIntent = new Intent(Intent.ACTION_VIEW, gmmIntentUri);
      sendIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
