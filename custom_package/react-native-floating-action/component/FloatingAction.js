...
class FloatingAction extends Component {
  ...
  getIcon = () => {
    ...
    if (overrideWithAction) {
      ...
      return <FastImage style={{ width: iconWidth, height: iconHeight }} source={icon} />;
    }
    ...
    if (floatingIcon) {
      ...
      return <FastImage style={{ width: iconWidth, height: iconHeight }} source={floatingIcon} />;
    }
  ...
  render() {
    ...
    return (
      <Animated.View
        ...
        style={[styles.overlay, { backgroundColor: this.state.active ? 'rgba(0,0,0,.6)' : 'transparent' }]}
      >
        {
