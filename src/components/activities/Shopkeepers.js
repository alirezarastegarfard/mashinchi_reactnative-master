...
class Shopkeepers extends Component {
    ...
    render() {
        ...
        return (
            <BaseUi
                ...
                <MyHeader showText={true} text={'مغازه داران'}/>

                <ScrollView>
                    <View style={Shopkeepers_Style.MainViewStyle}>

                        <FastImage style={Shopkeepers_Style.ImageViewStyle}
                               source={{uri: BaseURL + ImagesAddress + this.props.ImageFileName}}
                        />

                        <MyInput
                            placeholder={"نام و نام خانوادگی صاحب جواز کسب"}
                            placeholderTextColor={SecondaryTextColor}
                            viewStyle={Shopkeepers_Style.InputStyle}
                        ...
                        <MyButton
                            viewStyle={Shopkeepers_Style.ButtonStyle}
    ...
    VerifyMobile() {
        ...
        if (state.PermissionFullName.trim() === "") {
            Actions.ExceptionDialog({Message: "ورود نام و نام خانوادگی صاحب جواز الزامی است"});
            return;
        }

        if (state.JobTitle.trim() === "") {
            Actions.ExceptionDialog({Message: "ورود عنوان شغل الزامی می باشد"});
            return;
        }
...
const Shopkeepers_Style = StyleSheet.create({
...
export default connect(mapStateToProps)(Shopkeepers);
