...
import TitleVideoList from "../../customs/List/TitleVideoList";
import {GET_POST_TYPE_INSTAGRAM} from "../../publics/Constant";

export default class PostsSearch extends React.Component {
    ...
    fetchDataAPI() {
        ...
        const Parameter = JSON.stringify({
            ...
            GetPostType  : GET_POST_TYPE_INSTAGRAM
        });
