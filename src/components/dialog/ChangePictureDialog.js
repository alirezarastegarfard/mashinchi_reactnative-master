...
export default class ChangePictureDialog extends BaseLightbox {
            ...
            <BaseLightbox
                ...
                <View style={{flex: 1,backgroundColor:'white',paddingRight:5,borderRadius:10}}>
                    ...
                    <TouchableOpacity
                        ...
                        style={{
                            flex: 0.33, justifyContent: 'center', alignItems: 'center', flexDirection: 'row',
                    ...
                    <TouchableOpacity
                        ...
                        <View style={{flex: 0.8, justifyContent: 'center', alignItems: 'center'}}>
                            <MyText
                                componentStyles={{width: '85%', textAlign: 'right'}}
                                text={'حذف عکس پروفایل'}
                            />

                        </View>

                        <View style={{flex: 0.1}}>
                            <FastImage source={require('../../assets/images/icons/trash.png')}
                                   style={{width: '100%', height: '100%'}}
                                   resizeMode={'contain'}
                            />
                        </View>
